...
\begin{document}
    ...
    \begin{header}
        \textbf{\fontsize{24 pt}{24 pt}\selectfont Yongjae Lee}

        \vspace{0.3 cm}

        \normalsize
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{yongzzai1102@gmail.com}{\color{black}{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}yongzzai1102@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://yongzzai.com/}{\color{black}{\footnotesize\faLink}\hspace*{0.13cm}Personal Website}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/yongjae-lee-93b935312/}{\color{black}{\footnotesize\faLinkedin}\hspace*{0.13cm}Linkedin}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/yongzzai}{\color{black}{\footnotesize\faGithub}\hspace*{0.13cm}GitHub}}%
        \kern 0.25 cm%
        \AND%
        \mbox{\hrefWithoutArrow{https://scholar.google.com/citations?user=YxFIm0AAAAAJ&hl=ko}{\color{black}{\footnotesize\faBook}\hspace*{0.13cm}Scholar}}
    \end{header}
